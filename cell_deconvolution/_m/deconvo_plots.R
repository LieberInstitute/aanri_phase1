...
load("est_prop_Bisque.Rdata",verbose = TRUE)
...
long_prop %>% filter(prop== 1)
#     RNum cell_type prop  BrNum  Region Sex Race
# 1 R13321     Oligo    1 Br1492 Caudate   M   AA
# 2  R5460     Oligo    1 Br1455   HIPPO   M   AA
# 3  R3464     Oligo    1 Br1811   DLPFC   F   AA
...
#### Calculate p-values ####
prop_qSV_fit <- map(est_prop_qsv[c("caudate", "hippo", "dlpfc")], ~.x %>% 
