...
prep_data <- function(feature){
    ...
    counts_lt = list("genes"="../../../../input/counts/_m/hippo_brainseq_phase2_hg38_rseGene_merged_n447.rda", 
                     "transcripts"="../../../../input/counts/_m/hippo_brainseq_phase2_hg38_rseTx_merged_n447.rda",
                     "exons"="../../../../input/counts/_m/hippo_brainseq_phase2_hg38_rseExon_merged_n447.rda",
                     "junctions"="../../../../input/counts/_m/hippo_brainseq_phase2_hg38_rseJxn_merged_n447.rda")
...
qSV_model <- function(feature){
    ...
    # Load qSV
    qsv_file = "../../../../input/phenotypes/_m/qSV_hippo.csv"
