...
prep_data <- function(feature){
    ...
    counts_lt = list("genes"=here("input/counts/_m",
                     ...
                     "transcripts"=here("input/counts/_m",
                                        "astellas_dg_hg38_rseTx_n263.rda"),
                     "exons"=here("input/counts/_m",
                                  "astellas_dg_hg38_rseExon_n263.rda"),
                     "junctions"=here("input/counts/_m",
                                      "astellas_dg_hg38_rseJxn_n263.rda"))
    tx_file = here("input/counts/_m/transcripts_counts/dg_counts.txt")
    ...
    if(exists("rse_gene")){
        ...
        rownames(colData(rse_tx)) <- colnames(counts)
...
get_qSVs <- function(){
    qsv_file = here("input/phenotypes/_m/qSV_dg.csv")
