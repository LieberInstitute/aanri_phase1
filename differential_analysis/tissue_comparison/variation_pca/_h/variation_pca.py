...
# def pc_recursive(tissue):
#     new_tissue = [tissue.lower() if tissue != "Dentate Gyrus" else "dentateGyrus"]
#     pheno_df = get_pheno_data()
#     pvals = []; rsq = []; simus = []
#     for simu in range(1000):
#         expr_res = get_res_df(simu, tissue, False)
...
#       .sort_values("Simulation", ascending=True)\
#       .to_csv("%s/variance_explained_rsq_1000_permutations.csv" % new_tissue[0],
#               index=False)
