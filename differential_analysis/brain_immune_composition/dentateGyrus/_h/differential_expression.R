...
get_cell_composition <- function(){
    ...
    return(est_prop_bisque$dg$bulk.props %>% as.data.frame() %>%
           tibble::rownames_to_column("RNum") %>%
           separate(RNum, c("RNum", "batch")) %>%
...
prep_data <- function(feature){
    ...
    counts_lt = list("genes"=here("input/counts/_m/astellas_dg_hg38_rseGene_n263.rda"), 
                     "transcripts"=here("input/counts/_m/astellas_dg_hg38_rseTx_n263.rda"),
                     "exons"=here("input/counts/_m/astellas_dg_hg38_rseExon_n263.rda"),
                     "junctions"=here("input/counts/_m/astellas_dg_hg38_rseJxn_n263.rda"))
