...
def get_mash_obs(feature):
    fn = "/dcs04/lieber/statsgen/jbenjami/projects/aanri_phase1/" +\
        "differential_analysis/tissue_comparison/_m/%s/" % feature +\
...
def get_eGene(tissue, feature, lfsr):
    fn = "/dcs04/lieber/statsgen/jbenjami/projects/aanri_phase1/" +\
        "eqtl_analysis/tissue_comparison/feature_summary/_m/" +\
...
def get_sig(tissue, feature, lfsr = 0.05):
    shared_features = set(get_deg(tissue, feature).Effect) & set(merge_data(feature).index)
