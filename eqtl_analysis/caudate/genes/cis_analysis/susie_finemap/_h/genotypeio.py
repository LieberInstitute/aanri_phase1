...
class PlinkReader(object):
    def __init__(self, plink_prefix_path, fam_id="iid", select_samples=None, include_variants=None,
    ...
    def get_genotype(self, variant_id, fam_id='iid', sample_ids=None, impute=False, verbose=False, dtype=np.int8):
...
def load_genotypes(plink_prefix_path, fam_id="iid", select_samples=None, dtype=np.int8):
    ...
    pr = PlinkReader(plink_prefix_path, fam_id="iid", select_samples=select_samples, dtype=dtype)
