...
def get_annotation():
    ...
    config = {
        "genes": "%s/_m/hippocampus/gene_annotation.tsv" % base_loc,
        "transcripts": "%s/_m/hippocampus/tx_annotation.tsv" % base_loc,
        "exons": "%s/_m/hippocampus/exon_annotation.tsv" % base_loc,
        "junctions": "%s/_m/hippocampus/jxn_annotation.tsv" % base_loc,
    }
