...
prepare_data <- function(){
                                        # Load sample data
    fn1 <- paste0("../../../../../internal_replication/",
                  "dentateGyrus/_m/transcripts/voomSVA.RData")
    ...
    fn2 <- paste0("../../../../../internal_replication/",
                  "dentateGyrus/_m/transcripts/residualized_expression.tsv")
